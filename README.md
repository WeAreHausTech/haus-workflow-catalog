...
**Authoring vs safety** (see [ADR-0001](docs/decisions/0001-curated-verbatim-skill-import.md)):
...
Cross-repo decision log: [`haus-workflow` ADR-0001](https://github.com/WeAreHausTech/haus-workflow/blob/main/docs/decisions/0001-validation-rules-single-source.md).
